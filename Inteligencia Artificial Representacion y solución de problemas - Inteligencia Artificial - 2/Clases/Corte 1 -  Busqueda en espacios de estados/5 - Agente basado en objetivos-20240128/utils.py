...
class Experiment :
    ...
    def __init__(self, \
        ...
        #Â Reserve attribute for generated data
        self.data = None
    ...
    def load_test_suite(self, file_name:str):
        ...
        for test in env_data:
            ...
            #Â Creates environment of the given class
            exec(f'env = {test["env_class"]}()')
            #Â Modifies environmental parameters according to data
        ...
        Input:
            ...
            - measures, list of measures, which could contain the following strings:
             ...
             - verbose, to print information.
                ...
                4: simulation, episode and round information
        '''
        #Â Determines if test suite is already created/loaded
